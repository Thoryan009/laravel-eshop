                ...
                <div class="col-lg-6 col-md-12 col-12">
                    ...
                    <div class="top-left">
                        <ul class="list-main">
                            ...
                            <li><i class="ti-email"></i> <a href="https://wpthemesgrid.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="fa898f8a8a95888eba8992958a928f98d4999597">[email&#160;protected]</a></li>
                        </ul>
                    </div>
                    <!--/ End Top Left -->
                </div>
                       ...
                       @if(Session::get('id'))
                        ...
                        @else
                            <ul class="list-main">
                                ...
                                <li><i class="ti-power-off"></i><a href="{{route('customer.login.page')}}">Login</a></li>
                            </ul>
                           @endif
                    </div>
                    <!-- End Top Right -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-2 col-md-2 col-12">
                    <!-- Logo -->
                    <div class="logo">
                        <a href="{{route('home')}}"><img src="{{asset('/')}}frondend_assets/images/logo.png" alt="logo"></a>
                    </div>
                    <!--/ End Logo -->
                    <!-- Search Form -->
                            ...
                            <div class="shopping-item">
                                ...
                                <ul class="shopping-list">
                                    <li>
                                        ...
                                        <a class="cart-img" href="#"><img src="{{asset('/')}}frondend_assets/images/product-1.jpg" alt="#"></a>
                                        <h4><a href="#">Woman Ring</a></h4>
                                        <p class="quantity">1x - <span class="amount">$99.00</span></p>
                                    </li>
                                    <li>
                                        <a href="#" class="remove" title="Remove this item"><i class="fa fa-remove"></i></a>
                                        <a class="cart-img" href="#"><img src="{{asset('/')}}frondend_assets/images/product-2.jpg" alt="#"></a>
...
{{--                                            <div class="image">--}}
{{--                                                <img src="{{asset('/')}}frondend_assets/images/mega-menu1.jpg" alt="#">--}}
{{--                                            </div>--}}
...
{{--                                            <div class="image">--}}
{{--                                                <img src="{{asset('/')}}frondend_assets/images/mega-menu2.jpg" alt="#">--}}
{{--                                            </div>--}}
{{--                                            <div class="inner-link">--}}
{{--                                                <a href="#">Watch</a>--}}
{{--                                                <a href="#">T-shirt</a>--}}
...
{{--                                            <div class="image">--}}
{{--                                                <img src="{{asset('/')}}frondend_assets/images/mega-menu3.jpg" alt="#">--}}
{{--                                            </div>--}}
{{--                                            <div class="inner-link">--}}
            ...
            <div class="row">
                <div class="col-lg-5 col-md-6 col-12">
                    ...
                    <div class="single-footer about">
                        <div class="logo">
                            <a href="index-2.html"><img src="{{asset('/')}}frondend_assets/images/logo2.png" alt="#"></a>
                        </div>
                    ...
                    <div class="single-footer social">
                        ...
                        <div class="contact">
                            <ul>
                                ...
                                <li><a href="https://wpthemesgrid.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="e0898e868fa08593888f90ce838f8d">[email&#160;protected]</a></li>
                                <li>+032 3456 7890</li>
                            </ul>
                        </div>
                        <!-- End Single Widget -->
...
<!-- Jquery -->
<script data-cfasync="false" src="{{asset('/')}}frondend_assets/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script>
...
<script>(function(){function c(){var b=a.contentDocument||a.contentWindow.document;if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'92019becabbd8b01',t:'MTc0MTkzMjYzOS4wMDAwMDA='};var a=document.createElement('script');a.nonce='';a.src='../../cdn-cgi/challenge-platform/h/b/scripts/jsd/c8ec7565fab7/maind41d.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body>
