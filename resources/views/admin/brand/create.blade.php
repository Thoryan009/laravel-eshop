            ...
            <form action="{{route('brand.store')}}" method="post" enctype="multipart/form-data">
                ...
                >
                    ...
                    <label class="block text-sm mt-3">
                        <span class="text-gray-700 dark:text-gray-400">Brand Image</span>
                        <input
                            type="file"
                    ...
                    <label class="block mt-4 text-sm">
                        <span class="text-gray-700 dark:text-gray-400">Brand Description</span>
                        <textarea
