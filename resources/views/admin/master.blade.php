            ...
            <ul>
                ...
                <li class="relative px-6 py-3">
                    <details class="dropdown">
                        <summary class="btn m-1">Category Module</summary>
                        <ul class="menu dropdown-content bg-base-100 rounded-box z-1 w-52 px-6 shadow-sm ">
                            <li class="py-3"><a href="{{route('category.create')}}">Add Category</a></li>
                ...
                <li class="relative px-6 py-3">
                    <details class="dropdown">
                        <summary class="btn m-1">Sub Category Module</summary>
                        <ul class="menu dropdown-content bg-base-100 rounded-box z-1 w-52 px-6 shadow-sm">
                            <li class="py-3"><a href="{{route('subCategory.create')}}">Add Sub Category</a></li>
                ...
                <li class="relative px-6 py-3">
                    <details class="dropdown">
                        <summary class="btn m-1">Brand Module</summary>
                        <ul class="menu dropdown-content bg-base-100 rounded-box z-1 w-52 px-6 shadow-sm">
                            <li class="py-3"><a href="{{route('brand.create')}}">Add Brand</a></li>
                ...
                <li class="relative px-6 py-3">
                    <details class="dropdown">
                        <summary class="btn m-1">Unit Module</summary>
                        <ul class="menu dropdown-content bg-base-100 rounded-box z-1 w-52 px-6 shadow-sm">
                            <li class="py-3"><a href="{{route('unit.create')}}">Add Unit</a></li>
                ...
                <li class="relative px-6 py-3">
                    <details class="dropdown">
                        <summary class="btn m-1">Product Module</summary>
                        <ul class="menu dropdown-content bg-base-100 rounded-box z-1 w-52 px-6 shadow-sm">
                            <li class="py-3"><a href="{{route('product.create')}}">Add Product</a></li>
                ...
                <li class="relative px-6 py-3">
                    <details class="dropdown">
                        <summary class="btn m-1">User Module</summary>
                        <ul class="menu dropdown-content bg-base-100 rounded-box z-1 w-52 px-6 shadow-sm">
                            <li class="py-3"><a href="{{route('category.create')}}">Add User</a></li>
                ...
                <li class="relative px-6 py-3">
                    <details class="dropdown">
                        <summary class="btn m-1">Courier Module</summary>
                        <ul class="menu dropdown-content bg-base-100 rounded-box z-1 w-52 px-6 shadow-sm">
                            <li class="py-3"><a href="{{route('category.create')}}">Add Courier</a></li>
                            <li ><a>Manage Courier</a></li>
                        </ul>
                    </details>
                </li>
...
<script>
    ...
    ClassicEditor
        .create( document.querySelector( '#editor' ), {
            ...
            plugins: [ Essentials, Bold, Italic, Font, Paragraph, Indent, IndentBlock, List ],
            toolbar: [
                '|', 'bold', 'italic', '|',
                'fontSize', 'fontFamily', 'fontColor', 'fontBackgroundColor', 'outdent', 'indent', 'bulletedList', 'numberedList', '|',
